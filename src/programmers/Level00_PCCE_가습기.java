...
public class Level00_PCCE_가습기 {

    public static void main(String[] args) {
        System.out.println(solution("auto", 23, 45)); // 3
        System.out.println(solution("target", 41, 40)); // 1
        System.out.println(solution("minimum", 10, 34)); // 1
    }
